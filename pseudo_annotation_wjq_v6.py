...
if __name__ == '__main__':
    ...
    pseudo_annotation_dir = '/data8/hzp/emo_bert/data/pseudo_annotations_v6' #用于存放情感伪标注信息的根目录
    ...
    #-----test----------
    movie_folder_list = ['No0641_None']
    # 323没跑出来。 
    #movie_folder_list_ = movie_folder_list[331:]
    #movie_folder_list = movie_folder_list_
    #-------------------
